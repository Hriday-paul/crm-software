    ...
    return (
        <>
            ...
            <dialog ref={modalRef} className="modal">
                ...
                <div className='modal-box !rounded dark:!bg-boxdark !z-1 !p-0'>
                    <div className="flex sticky top-0 bg-white dark:bg-boxdark justify-between items-center px-4 py-2 border-b border-stroke dark:border-strokedark">
