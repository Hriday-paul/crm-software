...
import { useAddNewAccountMutation } from '../../../../Redux/Features/BaseApi';
import { toast } from 'react-toastify';

export type add_account_type = {
    name: string;
    balance: number;
    account_num ?: string;
...
const AddAccountForm = React.memo(() => {
    const [postAccount, {isLoading, isError, error, isSuccess, data}] = useAddNewAccountMutation();
    const {
        register,
        handleSubmit,
        reset,
    ...
    const handleAddAccount: SubmitHandler<add_account_type> = (data) => {
    ...
    return (
        <div className='p-8'>
            <form className="" onSubmit={handleSubmit(handleAddAccount)}>
